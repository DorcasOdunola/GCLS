...
Route::post('/get_all_lessons_for_student', [LessonController::class, 'getAllLessonForStudent']);
...
Route::post('/quizzes_student', [QuizController::class, 'getAllQuizForStudent']);
...
Route::post('/leaderboard', [LeaderboardController::class, 'getLeaderboard']);
